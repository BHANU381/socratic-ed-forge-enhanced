...
EXPECTED_KWARGS = {
    ...
    "patch_editor.md": {"draft", "feedback", "heading", "course_topic", "submodule_title", "learner_level", "patch_mode", "issues", "lesson_contract", "running_summary", "breakdown", "topic_constraints", "edge_cases", "action_items", "common_mistakes", "expert_heuristic", "evaluation_path"},
