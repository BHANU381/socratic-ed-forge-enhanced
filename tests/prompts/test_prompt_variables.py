...
EXPECTED_KWARGS = {
    ...
    "content_generator.md": {"course_name", "course_topic", "duration_weeks", "module_title", "sub_title", "submodule_title", "content_context", "module_context", "running_summary", "learned_rules", "source_context", "learning_context_block", "lesson_contract", "quality_profile", "learner_level", "code_example_style", "explanation_depth", "module_position", "learner_level_rules", "core_idea_words", "implementation_words", "why_it_matters_words", "breakdown", "topic_constraints", "edge_cases", "action_items", "common_mistakes", "expert_heuristic", "evaluation_path", "tool_stack", "grounding_context", "concept"},
    "semantic_evaluator.md": {"draft", "lesson_contract", "course_topic", "submodule_title", "running_summary", "learner_level", "code_example_style", "explanation_depth", "module_position", "breakdown", "topic_constraints", "edge_cases", "action_items", "common_mistakes", "expert_heuristic", "evaluation_path"},
    "patch_editor.md": {"draft", "feedback", "heading", "course_topic", "submodule_title", "learner_level", "patch_mode", "issues", "lesson_contract", "running_summary", "breakdown", "topic_constraints", "edge_cases", "action_items", "common_mistakes", "expert_heuristic", "evaluation_path", "grounding_context"},
