...
EXPECTED_KWARGS = {
    "archivist.md": {"course_name", "course_topic", "duration_weeks", "sub_title", "submodule_title", "content_context", "module_context", "feedback", "critic_feedback", "learning_context_block", "draft", "lesson_draft", "module_title", "running_summary", "source_context", "learned_rules", "approved_lesson"},
    "content_generator.md": {"course_name", "course_topic", "duration_weeks", "module_title", "sub_title", "submodule_title", "content_context", "module_context", "running_summary", "learned_rules", "source_context", "learning_context_block"},
...
@pytest.mark.parametrize("theme, filename, filepath", get_all_prompts())
